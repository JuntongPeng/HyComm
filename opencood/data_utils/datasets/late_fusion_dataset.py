...
def getLateFusionDataset(cls):
    ...
    class LateFusionDataset(cls):
        def __init__(self, params, visualize, train=True):
            ...
            # print(self.params['preprocess']['down_sample'])
        ...
        def post_process(self, data_dict, output_dict):
            ...
            #if self.store_boxes:
            if True:
                pred_box_tensor, pred_score, uncertainty ,points_num= \
                    self.post_processor.post_process(data_dict, output_dict,True,True)
                ...
                if uncertainty!=None:
                    ...
                    uncx=None
                    uncy=None
                return pred_box_tensor, pred_score, gt_box_tensor,uncx,uncy,points_num
